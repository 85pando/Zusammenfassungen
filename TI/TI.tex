...
\begin{description}
    ...
    \item[äquivalent:] \red{Wenn mir jemand sagen kann, was hier rein kommt, bitte zuschicken {\tiny ist aber auch nicht so wichtig$\dots$} }
...
\begin{shaded}
    ...
    \begin{minipage}{0.48\textwidth}
        \begin{center}
        \ \\[.5cm]
        \scalebox{0.75}{\input{images/pumping-reg.tikz}}
        \end{center}
    \end{minipage}
\end{shaded}
\begin{description}
...
\begin{shaded}
    ...
    \begin{minipage}{0.48\textwidth}
        \begin{center}
        \ \\[.5cm]
        \scalebox{0.75}{\input{images/pumping-kf.tikz}}
        \end{center}
    \end{minipage}
\end{shaded}
...
\begin{description}
    ...
    \item[Äquivalenzproblem] \red{WAS MUSS HIER HIN}
\end{description}
